...
namespace MoptAvalara6\Controller\SupportForm;

use MoptAvalara6\Bootstrap\Form;
use MoptAvalara6\Service\LogHelper;
use MoptAvalara6\Service\SupportAccount;
...
class SupportFormController extends AbstractController
{
    ...
    #[Route(
        path: '/api/_action/avalara/support-form/check-user-rights',
        name: 'api.action.avalara.support-form.check-user-rights',
        methods: ['POST']
    )]
    ...
    #[Route(
        path: '/api/_action/avalara/support-form/send',
        name: 'api.action.avalara.support-form.send',
        methods: ['POST']
    )]
    ...
    #[Route(
        path: '/api/_action/avalara/support-form/download_log',
        name: 'api.action.avalara.support-form.download_log',
        methods: ['POST']
    )]
